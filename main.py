...
from tkinter.ttk import Combobox, Style, Notebook, Button, LabelFrame
...
def Save():
    ...
    Save_Data_SQLite(B2,C2,int(D2),int(E2),int(F2),int(G2),int(H2),int(I2),int(J2),int(K2),int(L2),int(M2),float(N2),int(O2),int(P2),int(Q2),int(prediction[0]))
